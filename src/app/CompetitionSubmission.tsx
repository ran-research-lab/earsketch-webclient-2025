            ...
            <div>
                <div className="text-lg text-center mb-4">
                    ...
                    <ul className="list-disc text-left p-5 pl-10 space-y-1 bg-gray-100 dark:bg-gray-800">
                        <li>Submission deadline is 11:59PM PST on June 21st, 2024</li>
                        <li>Song must be between 30 seconds and 2 minutes, include 5 unique musical tracks, and be a remix including stems from more than one artist (MS/HS students must also include a for loop)</li>
