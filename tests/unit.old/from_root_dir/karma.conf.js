  ...
  config.set({
    ...
    frameworks: ['jasmine'],
      ...
      files: [
          ...
          // Skulpt
          {pattern: 'scripts/lib/skulpt.min.js', included:true},
          {pattern: 'scripts/lib/skulpt-stdlib.js', included:true},
          ...
          //jQuery
          {pattern: 'scripts/vendor/bower_components/jquery/dist/jquery.min.js', included:true},
...
//          {pattern: 'scripts/collapse.js', included:true},
          ...
          //Angular Libraries
          {pattern: 'scripts/vendor/bower_components/angular/angular.min.js', included:true},
          ...
          {pattern: 'scripts/src/app/renamecontroller.js', included:true},
          {pattern: 'scripts/src/app/sharecontroller.js', included:true},
          {pattern: 'scripts/src/app/soundbrowsercontroller.js', included:true},
          {pattern: 'scripts/src/app/scriptbrowsercontroller.js', included:true},
          {pattern: 'scripts/src/app/apibrowsercontroller.js', included:true},
          {pattern: 'scripts/src/app/createaccountcontroller.js', included:true},
          {pattern: 'scripts/src/app/forgotpasswordcontroller.js', included:true},
          ...
          //Bootstrap
          {pattern: 'scripts/vendor/bower_components/bootstrap/dist/js/bootstrap.min.js', included:true},
