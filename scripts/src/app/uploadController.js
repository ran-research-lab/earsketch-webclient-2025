...
app.controller("UploadSoundCtrl", ['$scope','$uibModalInstance','RecorderService','userProject','userNotification','audioLibrary','$sce', '$timeout', '$http', '$ngRedux' , function($scope, $uibModalInstance, RecorderService, userProject, userNotification, audioLibrary, $sce, $timeout, $http, $ngRedux) {
    $scope.file = {
        data: null,
        key: null,
        tempo: null
