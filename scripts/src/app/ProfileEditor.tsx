...
export const ProfileEditor = ({ username, password, email, role, firstName, lastName, close }:
    { username: string, password: string, email: string, role: string, firstName: string, lastName: string, close: (info?: any) => void }) => {
    const [mode, setMode] = useState("details")
    if (mode === "details") {
        return <DetailEditor {...{username, password, email, role, firstName, lastName, close}} changePassword={() => setMode("password")} />
    } else {
        return <PasswordEditor close={close} />
    }
}

export const DetailEditor = ({ username, password, email: _email, role, firstName: _firstName, lastName: _lastName, changePassword, close }:
