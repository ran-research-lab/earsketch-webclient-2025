...
app.controller("scriptVersionController", ['$scope', '$uibModalInstance', 'script', 'userProject', 'compiler', 'reporter', 'collaboration', 'allowRevert', '$ngRedux', function ($scope, $uibModalInstance, script, userProject, compiler, reporter, collaboration, allowRevert, $ngRedux) {
    $scope.script = script;
