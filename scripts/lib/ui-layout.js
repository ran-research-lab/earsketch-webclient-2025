...
// modified line 268 for the curriculum-pane full-screen hack (or I might call it a fix... this library is buggy). (Oct 25, 2016)
...
angular.module('ui.layout', [])
  ...
  function uiLayoutCtrl($scope, $attrs, $element, $timeout, $window, LayoutContainer, Layout) {
    ...
    opts.dividerSize = opts.dividerSize === undefined ? 9 : opts.dividerSize;
